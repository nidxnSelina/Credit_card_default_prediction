...
Tuning shrinkage
(library(caret) doesn't work on my device, so I did the tuning manually)
```{r}
...
# Appendix
7.1 Tuning the hyperparater max_depth for xgboost model, which yields the same value with the default
```{r}
